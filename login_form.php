			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to UK Learning Management System", { header: 'Access Granted' });
									var delay = 1000;
										setTimeout(function(){ window.location = 'dasboard_teacher.php'  }, delay);  
									}else if (html == 'true_student'){
										$.jGrowl("Welcome to CHMSC Learning Management System", { header: 'Access Granted' });
									var delay = 1000;
										setTimeout(function(){ window.location = 'course.php'  }, delay);  
									}else
									{
			...
			<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as Teacher" id="signin_teacher" onclick="window.location='admin/'" name="login" class="btn btn-info" type="submit">I`m a Lecturer</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
